...
declare namespace chrome.accessibilityFeatures {
  ...
  interface AccessibilityFeaturesSetting {
    ...
    ): Promise<AccessibilityFeaturesCallbackArg>;
    /**
...
declare namespace chrome.bookmarks {
  ...
  interface BookmarkChildrenReordered
...
declare namespace chrome.devtools.inspectedWindow {
  ...
  export function eval(
    expression: string,
    callback?: (result: Object, exceptionInfo: EvaluationExceptionInfo) => void,
  ): void;
  /**
...
declare namespace chrome.documentScan {
  ...
  ): Promise<DocumentScanCallbackArg>;
}
...
declare namespace chrome.fileBrowserHandler {
  ...
  interface FileBrowserHandlerExecuteEvent
...
declare namespace chrome.fileSystemProvider {
  ...
  interface MetadataRequestedEvent
    extends chrome.events.Event<
      (
  ...
  interface DirectoryPathRequestedEvent
    extends chrome.events.Event<
      (
  ...
  interface OpenFileRequestedEvent
    extends chrome.events.Event<
      (
  ...
  interface OpenedFileRequestedEvent
    extends chrome.events.Event<
      (
  ...
  interface OpenedFileOffsetRequestedEvent
    extends chrome.events.Event<
      (
  ...
  interface DirectoryPathRecursiveRequestedEvent
    extends chrome.events.Event<
      (
  ...
  interface EntryPathRecursiveRequestedEvent
    extends chrome.events.Event<
      (
  ...
  interface FilePathRequestedEvent
    extends chrome.events.Event<
      (
  ...
  interface SourceTargetPathRequestedEvent
    extends chrome.events.Event<
      (
  ...
  interface FilePathLengthRequestedEvent
    extends chrome.events.Event<
      (
  ...
  interface OpenedFileIoRequestedEvent
    extends chrome.events.Event<
      (
  ...
  interface OperationRequestedEvent
    extends chrome.events.Event<
      (
  ...
  interface OptionlessRequestedEvent
...
declare namespace chrome.input.ime {
  ...
  interface CandidateClickedEvent
  ...
  interface SurroundingTextChangedEvent
...
declare namespace chrome.notifications {
  ...
  interface NotificationButtonClickedEvent
...
declare namespace chrome.omnibox {
  ...
  interface OmniboxInputChangedEvent
...
declare namespace chrome.platformKeys {
  ...
  ): Promise<ServerCertificateVerificationResult>;
}
...
declare namespace chrome.runtime {
  ...
  export function requestUpdateCheck(
    callback?: (status: string, details?: UpdateCheckDetails) => void,
  ): Promise<{ status: string; details?: UpdateCheckDetails }>;
  /**
...
declare namespace chrome.storage {
  ...
  interface StorageChangedEvent
    extends chrome.events.Event<(changes: { [key: string]: StorageChange }, areaName: string) => void> {}
...
declare namespace chrome.webNavigation {
  ...
  interface WebNavigationEvent<T extends WebNavigationCallbackDetails>
...
declare namespace chrome.webRequest {
  ...
  interface WebAuthenticationChallengeEvent
    ...
    > {
    addListener(
      callback: (details: WebAuthenticationChallengeDetails) => void,
      filter?: RequestFilter,
      opt_extraInfoSpec?: string[],
    ): void;
  }
